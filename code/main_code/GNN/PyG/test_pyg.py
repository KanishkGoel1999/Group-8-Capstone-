...
#data_path = '/home/ubuntu/fraudTest.csv'
...
m_name = "GNN"
model_path = "/home/ubuntu/code/main_code/GNN/models/models/"+"best_pyg_model_DS2.pth"
#model_path = "/home/ubuntu/code/main_code/GNN/models/models/"+f'model_{m_name}.pth'
...
def evaluate():
    ...
    #     ['transaction_id', 'amt', 'hour_sin', 'hour_cos', 'day_sin', 'day_cos']].drop_duplicates(
    #     subset=['transaction_id'])
    # user_feats = df[
    #     ['card_number', 'city_encoded', 'state_encoded', 'zip_encoded', 'age_encoded', 'gender_encoded', 'lat',
    #      'long']].drop_duplicates(subset=['card_number'])
    ...
    merchant_feats = df[
        ['merchant_id', 'merchant_category_Education', 'merchant_category_Entertainment', 'merchant_category_Gas',
         'merchant_category_Grocery']].drop_duplicates(
        subset=['merchant_id'])
